    ...
    for count, a in enumerate(ofdm):
       ...
       # Setting applications
        ...
        if udp == False:
            ...
            serverApp = myServer.Install (ns.network.NodeContainer (wifiApNode.Get (0)))
            ...
            clientApp = myClient.Install (ns.network.NodeContainer (wifiStaNode.Get (0)))

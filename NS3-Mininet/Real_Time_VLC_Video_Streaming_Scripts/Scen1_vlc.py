...
def Start(GI=False, MCS=3, Bandwidth=40, UDP=True, TP=54, PCAP=False):
    ...
    if PCAP == True:
        ...
        wifi.phyhelper.EnablePcap( "Scen1_STA_VLCNS3MN.pcap", h0.nsNode.GetDevice( 0 ), True, True )
        #wifi.phyhelper.EnablePcap( "Ap-h1.pcap", h1.nsNode.GetDevice( 1 ), True, True );
        wifi.phyhelper.EnablePcap( "Scen1_AP_VLCNS3MN.pcap", h2.nsNode.GetDevice( 0 ), True, True )
